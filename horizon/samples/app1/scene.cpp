...
SceneData::SceneData(SceneManager *scene_manager, Backend::RHI *rhi) noexcept {
    ...
    scene_manager->scene_constants_buffer = scene_manager->resource_manager->CreateGpuBuffer(
        BufferCreateInfo{DescriptorType::DESCRIPTOR_TYPE_CONSTANT_BUFFER,
                         ResourceState::RESOURCE_STATE_NON_PIXEL_SHADER_RESOURCE, sizeof(SceneManager::SceneConstants)});
